        ...
        <div className="form-card">
          <div className="form-header">
            ...
            >
              ...
              <g clip-path="url(#clip0_3683_91070)">
                <g clip-path="url(#clip1_3683_91070)">
                  <path
            ...
            <h1 className="tw-text-center tw-text-2xl tw-font-bold tw-capitalize tw-not-italic tw-leading-9 tw-text-text-black">
              OTP Verification
            </h1>
            <p className="tw-text-center tw-text-sm tw-font-normal tw-not-italic tw-leading-[21px] tw-text-text-dark-gray">
            ...
            <div className="tw-mb-8 tw-flex tw-flex-col">
              <div className="tw-mb-4 tw-flex tw-gap-4">
                <input
                  ...
                  ref={otpNumber1}
                  className="tw-flex tw-flex tw-h-[43px] tw-w-[50px] tw-flex-row tw-items-center tw-items-center tw-gap-2 tw-rounded-[1px] tw-border-b tw-border-solid tw-border-b-disabled-input tw-px-3 tw-py-[11px] tw-text-center tw-text-[1.4rem] tw-font-medium tw-not-italic tw-leading-[2.1rem] tw-text-text-dark-gray"
                />
                <input
                  id="2"
                  type="text"
