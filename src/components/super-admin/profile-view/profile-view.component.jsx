...
export default function ProfileView() {
  const { passOpen, setPassOpen, handleOpenUpdate } = useViewProfile();
  return (
      ...
      <div className="common-box tw-mt-[24px] ">
        ...
        <div className="form-box  tw-ml-[24px] tw-mr-[24px] tw-mt-[121px] tw-w-[95%]">
          ...
          <div className="tw-grid  tw-grid-cols-[750px_1fr] tw-gap-[30px]">
            ...
            <div className="textarei-side tw-relative">
              <div className="tw-absolute tw-right-1 tw-top-[-30px]">
                <CustomButton text="Edit" className="btn-primary" />
              </div>
              <label className=" tw-mr-1 tw-mt-4 tw-flex tw-min-w-fit tw-flex-row">
                Address
              </label>
