              ...
              <ul className="tw-flex tw-flex-col">
                {documentstimeline?.map((item) => {
                  return (
                    <li
                      key={item.id}
                      className="tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-1 tw-border-b-[1px] tw-border-border-gray3 tw-py-4"
                    >
                      <div className="tw-flex tw-items-center tw-gap-4">
                        ...
                        <div className="tw-flex tw-flex-col tw-gap-1">
                          <h2 className="tw-font-dm tw-text-sm tw-font-normal tw-leading-5 tw-text-text-black">
                            {item.title}{' '}
                            <span
                              className={`tw-inline-block tw-rounded-3xl tw-px-2 tw-py-1 tw-font-dm tw-text-xs tw-font-normal tw-capitalize tw-leading-4 ${
        ...
        <Grid item xs={12} lg={7}>
          <div className="panel tw-p-0 xs:tw-ml-[0px] semixl:tw-ml-[10px]">
            <div className="tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-3 tw-p-4">
              ...
              <a
                href="/"
                className="btn-primary-blue tw-rounded-md tw-border-none tw-px-[21px] tw-py-[10px]"
              >
                Create Notes
              </a>
            </div>
            ...
            <div className="timeline_wrapper scroll_enable tw-mb-6 tw-mt-6 tw-max-h-[272px] tw-overflow-y-auto tw-pl-4 tw-pr-4">
              <ul className="tw-flex tw-flex-col">
                {notes?.map((item) => {
                  return (
                    <li key={item.id} className="tw-border-b-[1px] tw-border-t-[1px] tw-border-border-gray4 tw-px-6 tw-py-5">
                      <div className="tw-mb-6 tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-3">
                        <p className="tw-font-dm tw-text-sm tw-font-normal tw-leading-6 tw-text-text-dark-gray">
                          {item.date} <span className="tw-font-semibold">by {item.by}</span>
                        </p>
                        <a href="/">
                          <DeleteIconRed />
                        </a>
