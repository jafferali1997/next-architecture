  ...
  return (
    <>
      <table className="tw-w-full">
        <thead className=" tw-bg-secondaryLightBlue">
          <tr>
      ...
      <div className="tw-flex tw-justify-between">
        <div className="tw-flex tw-flex tw-items-center tw-gap-[8px] tw-pl-1 tw-font-dm tw-text-xs tw-font-normal tw-not-italic tw-leading-[18px]">
          <div>
            <span className="tw-leading-[18px]; tw-font-dm tw-text-xs tw-font-normal tw-not-italic">
              Show
            </span>
            <select
          ...
          <p className=" tw-pl-1">
            ...
            <span className="tw-pl-1 tw-text-textUltraLightGray">
